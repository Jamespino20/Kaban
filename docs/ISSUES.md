...
* [ ] When registering, new users should input how much money they have, how much their income is, and others so the system can gauge if they can pay back their loans. If the number is lower than the acceptable amount (tenant operator can edit this, by the way), they can't login. If their number is above the acceptable amount, the system calculates how much credit they can get in their Agapay account. I can't get past Register Step 3 as well.
...
* [ ] Profile pictures and username changes should appear in the Members list, the header profile part, and in the Community module.
* [ ] Destructive or irreversible actions should have "Are you sure?" modals
