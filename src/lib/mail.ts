...
export const sendTwoFactorTokenEmail = async (email: string, token: string) => {
  await transporter.sendMail({
    ...
    to: email,
    subject: "2FA Code - Kaban Shared Treasury",
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        <div style="background-color: #059669; padding: 40px; text-align: center;">
          <h1 style="color: white; margin: 0; font-style: italic;">Kaban</h1>
        </div>
        <div style="padding: 40px; color: #1e293b;">
          <h2 style="margin-top: 0;">Ang Inyong 2FA Code</h2>
          <p>Gamitin ang code sa ibaba upang makapasok sa iyong Kaban account.</p>
...
export const sendVerificationEmail = async (email: string, token: string) => {
  ...
  await transporter.sendMail({
    from: process.env.SMTP_FROM,
    to: email,
    subject: "I-verify ang iyong Kaban Account",
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        <div style="background-color: #059669; padding: 40px; text-align: center;">
          <h1 style="color: white; margin: 0; font-style: italic;">Kaban</h1>
        ...
        <div style="padding: 40px; color: #1e293b;">
          <h2>Handa na ang iyong Kaban!</h2>
