          ...
          {(() => {
            ...
            return Object.entries(grouped).map(([category, items]) => (
              <div key={category} className="space-y-1 mb-6">
                {!collapsed && (
                  <h3 className="mb-2 text-[10px] font-black uppercase tracking-[0.2em] text-white/50">
                    {category}
                  </h3>
                )}
                {items.map((item) => {
