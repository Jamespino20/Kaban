    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <History className="w-6 h-6 text-emerald-600" /> System Audit Trail
          </h3>
          <p className="text-sm text-slate-500">
            Real-time tracking of all database modifications and administrative
            actions.
          </p>
        </div>
      </div>
      ...
      {logs.length === 0 ? (
        <Card className="p-20 text-center flex flex-col items-center justify-center border-dashed">
          ...
          <p className="text-slate-500">No audit logs found for this period.</p>
        </Card>
      ) : (
